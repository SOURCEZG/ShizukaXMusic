...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(
                text=_["PL_B_12"], url=f"https://t.me/BARL0o0_HELP_SOURCE/13"
            ),
        ],
        [    
            InlineKeyboardButton(
                text=_["PL_B_13"], url=f"https://t.me/bar_lo0o0"
            ),
        ],        
        [
            InlineKeyboardButton(
                text=_["PL_B_3"], url=f"https://t.me/barlo0o_bot?startgroup=true",
            ),
        ],
    ]
    return buttons
